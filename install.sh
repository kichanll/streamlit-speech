...
LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/root/miniconda3/envs/streamlit_speech/lib/python3.7/site-packages/torch/lib:/root/miniconda3/envs/streamlit_speech/lib streamlit run app_deepspeech.py
